...
-- **Zad4** - Инициализация случайного массива из 10 чисел и нахождение максимального и минимального среди них <br>
...
### 7.10.2022 - 3 часа
* **Сделал домашнее задание №7** <br>
-- **Zad1** - Инициализация массива вещественными числами <br>
-- **Zad2** - Поиск элемента по его индексу <br>
-- **Zad3** - Сумма элементов столбца и строки. И среднее арифметическое элементов столбца и строки <br>
-- **Zad4** - Сравнение суммы элементов столбца с суммой элементов углов массива <br>

### 11.10.2022 - 5 часов + 3 часа
* **Создал папку Seminar8** (для решения задач на востмом семинаре) <br>
-- **task36** - Замена строчек и столбцов местами <br>
-- **task37** - Составление частотного словаря элементов двумерного массива <br>
-- **task38** - Удаление строки и столбца с минимальным значением массива <br>
-- **task40** - Сортировка пузырьком <br>
!!! Разобрать отдельно: <br>
поиск минимального и масимального значения в двумерном массиве, <br>
удаление строки и столбца, <br>
поиск индекса элемента по значению. <br>
* **Сделал домашнее задание №8** <br>
-- **Zad1** - Сортировка элементов в строке <br>
-- **Zad2** - Нахождение строки с максимальной и минимальной суммой элементов <br>
-- **Zad3** - Произведение двух матриц <br>
-- **Zad4** - Трехмерный массив <br>
-- **Zad5** -  <br>

### 12.10.2022 - 2 часа
* Разбор лекции №6
-- **task39** - Задача из 6 лекции. Перевод строчки в массив <br>

### 14.10.2022 - 2 часа
* **Создал папку Seminar9** (для решения задач на девятом семинаре)
-- **task41** - Вывод чисел от до с помощью рекурсии <br>

### 16.10.2022 - 3 часа
* **Сделал домашнее задание №9** <br>
-- **Zad1** - Четные числа от M до N с помощью рекеурсии <br>
-- **Zad2** - Сумма чисел от M до N  с помощью рекеурсии <br>
-- **Zad3** - Наибольший общий делитель <br>
-- **Zad4** - Функция Аккермана <br>
* ДЗ-8 **Zad5** - Заполнение массива по спирали <br>

### 17.10.2022 - 
* ДЗ-9 **Zad5** - Монотонная последовательность из N элементов в виде равностороннего треугольника <br>
-- **task42** - Сумма цифр в числе с помощью рекурсии <br>
-- **task43** - Треугольник Паскаля <br>
-- **task44** - Возведение числа A в степень B <br>




// Читание строки и вытаскивание элемента из строчки
// семинар 9 с 1:33:00 - посмотреть еще раз лекции про рекурсию 4 и 7 + 8 лекция